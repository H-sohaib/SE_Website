    ...
    <header id="header" class="d-flex align-items-center justify-content-between ps-3 pe-3 fixed-top">
        ...
        <nav id="navbar" class="navbar  me-5">
            <ul>
                <li class="admin-links"><a class="nav-link " href="{{ route('admin.index') }}">Accueil</a></li>
                ...
                <li class="admin-links">
                    <a class="nav-link scrollto" href="{{ route('admin.pfe_types.index') }}">PFE Types</a>
                </li>
                <li class="admin-links">
                    <a class="nav-link scrollto" href="{{ route('admin.pfe_exemples.index') }}">Exemples PFE</a>
                </li>
                <li class="admin-links">
                    <a class="nav-link scrollto" href="{{ route('admin.admin_management.index') }}">Gestion des
                        admins</a>
                </li>
